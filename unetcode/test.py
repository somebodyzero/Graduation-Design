...
def cal_miou(test_dir=r"C:\Users\LENOVO\Desktop\datatest\Test_Images",
             pred_dir=r"C:\Users\LENOVO\Desktop\datatest\result", gt_dir=r"C:\Users\LENOVO\Desktop\datatest\Test_Labels"):
    # ---------------------------------------------------------------------------#
    ...
    # --------------------------------------------#
    name_classes = ["background", "cerebellum"]
    # -------------------------------------------------------#
    #   指向VOC数据集所在的文件夹
    #   默认指向根目录下的VOC数据集
    # -------------------------------------------------------#
