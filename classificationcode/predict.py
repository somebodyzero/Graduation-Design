...
model_path = r"C:\Users\LENOVO\Downloads\checkpoints\resnet50d_pretrained_224\resnet50d_25epochs_accuracy0.99755_weights.pth"  # todo  模型路径
classes_names = ['HC', 'MSA']  # todo 类名
...
if __name__ == '__main__':
    ...
    predict_batch(model_path=model_path,
                  target_dir=r"C:\Users\LENOVO\Desktop\dataset-png\HC",
                  save_dir=r"C:\Users\LENOVO\Desktop\dataset-png\result")
    # 单张图片预测函数
