...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('多系统萎缩影像学辅助诊断系统')
        self.resize(1200, 800)
        self.setWindowIcon(QIcon("images/UI/brain.jpeg"))
        # 图片读取进程
        self.output_size = 480
        self.img2predict = ""
        self.origin_shape = ()

        self.model_path = r"C:\Users\LENOVO\Downloads\checkpoints\resnet50d_pretrained_224/resnet50d_42epochs_accuracy0.96569_weights.pth"  # todo  模型路径
        self.classes_names = ['非多系统萎缩', '多系统萎缩']  # todo 类名
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        img_detection_title = QLabel("MRI影像学辅助诊断")
        img_detection_title.setFont(font_title)
        mid_img_widget = QWidget()
        mid_img_layout = QHBoxLayout()
        self.left_img = QLabel()
        self.right_img = QLabel()
        self.left_img.setPixmap(QPixmap("images/UI/uppro.png"))
        ...
        up_img_button = QPushButton("上传颅脑MRI正中矢状位扫描片")
        det_img_button = QPushButton("辅助识别")
        ...
        *** 关于界面 ***
        ...
        self.left_img.setAlignment(Qt.AlignCenter)
        self.addTab(img_detection_widget, '医学影像分类')
        #self.addTab(about_widget, '找到我')
        self.setTabIcon(0, QIcon('images/UI/brain.jpeg'))
        #self.setTabIcon(1, QIcon('images/UI/brain.jpeg'))
    ...
    ***检测图片***
    ...
    def detect_img(self):
        ...
        self.rrr.setText("当前辅助判断结果为：{}".format(predict_name))
